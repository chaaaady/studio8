        ...
        <div className="bg-background border-2 border-border lg:border-2 lg:border-border border-0 rounded-2xl p-6 lg:p-8 shadow-lg lg:shadow-none animate-in slide-in-from-bottom-4 duration-700">
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              {/* Mobile marquee */}
                                        <div className="relative lg:hidden overflow-hidden bg-accent/30 rounded-xl p-4 animate-in slide-in-from-bottom-4 duration-700 delay-400">
              ...
              {/* Desktop grid */}
                                        <div className="hidden lg:grid grid-cols-3 gap-3 animate-in slide-in-from-bottom-4 duration-700 delay-400">
                {artists.map((artist, index) => (
                                                <div
                                key={index}
                                className="p-3 bg-accent/30 rounded-xl border border-border text-center hover:bg-accent/50 transition-all duration-300 hover:scale-105 hover:shadow-md"
                              >
