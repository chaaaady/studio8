        ...
        <div className="bg-background border-2 border-border rounded-2xl p-6 lg:p-8">
          <div className="space-y-12">
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="text-14 text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                <p className="mb-4">
              ...
              <div className="relative lg:hidden overflow-hidden bg-accent/30 rounded-xl p-4">
                <div className="animate-marquee-slow whitespace-nowrap">
                  {artists.map((artist, index) => (
                    <span key={index} className="mx-4 text-14 font-medium text-foreground">
                      {artist}
                    </span>
                  ))}
                  {artists.map((artist, index) => (
                    <span key={`duplicate-${index}`} className="mx-4 text-14 font-medium text-foreground">
                      {artist}
                    </span>
                  ))}
                </div>
